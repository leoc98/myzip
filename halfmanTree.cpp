...
void* HalfmanTree::codingMiddle(void* thisNode,
                                void* thisRet,
                                void* leftRet,
                                void* arg) {
    /*
...
void* HalfmanTree::codingAfter(void* thisNode,
                               void* thisRet,
                               void* leftRet,
                               void* middleRet,
                               void* rightRet,
...
struct cmpTreeNode {
    bool operator()(TreeNode* a, TreeNode* b) { return *a < *b; }
};
...
void* HalfmanTree::dfs(TreeNode* root,
...
void HalfmanTree::formReverseDir() {
    for (auto item : halfDirectory) {
        HalfmanValue* hv = item.second;
        uint8_t* data = hv->value;
        int bitLen = hv->bitLength;
